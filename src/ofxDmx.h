...
class ofxDmx {
 public:
  ...
  void activateMk2(unsigned char key0 = 0xC8, unsigned char key1 = 0xD0,
                   unsigned char key2 = 0x88, unsigned char key3 = 0xAD);
  void disconnect();
  ...
  void setChannels(
      unsigned int channels = 24);  // change the number of channels
  bool isConnected();
